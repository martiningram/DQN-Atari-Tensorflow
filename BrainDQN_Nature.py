...
class BrainDQN:
    ...
    def __init__(self, actions):
        ...
        (self.stateInput, self.QValue, self.W_conv1, self.b_conv1,
         self.W_conv2, self.b_conv2, self.W_conv3, self.b_conv3, self.W_fc1,
         self.b_fc1, self.W_fc2, self.b_fc2) = self.createQNetwork()

        # init Target Q Network
        (self.stateInputT, self.QValueT, self.W_conv1T,
         self.b_conv1T, self.W_conv2T, self.b_conv2T, self.W_conv3T,
         self.b_conv3T, self.W_fc1T, self.b_fc1T, self.W_fc2T,
    ...
    def createQNetwork(self):
        ...
        print ("dimension:", h_conv3_shape[1] * h_conv3_shape[2] *
               h_conv3_shape[3])
        ...
        return (stateInput, QValue, W_conv1, b_conv1, W_conv2, b_conv2,
    ...
    def createTrainingMethod(self):
        ...
        self.trainStep = tf.train.RMSPropOptimizer(
    ...
    def trainQNetwork(self):
        ...
        # Step 2: calculate y
        y_batch = []
        QValue_batch = self.QValueT.eval(
            feed_dict={self.stateInputT: nextState_batch})
    ...
    def setPerception(self, nextObservation, action, reward, terminal):
        newState = np.append(
            nextObservation, self.currentState[:, :, 1:], axis=2)
    ...
    def getAction(self):
        QValue = self.QValue.eval(
            feed_dict={self.stateInput: [self.currentState]})[0]
